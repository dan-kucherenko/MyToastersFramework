#
#  Be sure to run `pod spec lint MyToastersFramework.podspec' to ensure this is a
...
"
  ...
  spec.author             = { "Daniil Kucherenko" => "daniil.ukraine@gmail.com" }
  # Or just: spec.author    = "Daniil Kucherenko"
  # spec.authors            = { "Daniil Kucherenko" => "daniil.ukraine@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Daniil Kucherenko"
  ...
  spec.source       = { :git => "https://github.com/dan-kucherenko/MyToastersFramework.git", :tag => "#{spec.version}" }
